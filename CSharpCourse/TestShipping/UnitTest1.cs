...
namespace TestShipping
{
    ...
    public class UnitTest1
    {
        ...
        [DataRow(25)]
        [DataRow(50)]
        public void shipping_should_cost_88kr_for_0_to_50grams_recommended_letters_not_bulky(int weight)
        {
            var service = new ShippingService();
            var letter = new Letter(weight, true, false);
            decimal fee = service.CalculateShipping(letter);
        ...
        [DataRow(400)]
        [DataRow(500)]
        public void shipping_should_cost_54kr_for_251_to_500grams_regular_letters_not_bulky(int weight)
        {
            var service = new ShippingService();
